...
CREATE TABLE settings(
	...
	FOREIGN KEY (preferred_card_types_id) REFERENCES payment_card_types(id) ON UPDATE CASCADE,
	FOREIGN KEY (reservation_emails_id) REFERENCES reservation_emails(id) ON UPDATE CASCADE,
	FOREIGN KEY (newsletter_preferences_id) REFERENCES newsletter_preferences(id) ON UPDATE CASCADE
);
...
CREATE TABLE properties(
    ...
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE,
    FOREIGN KEY (property_type_id) REFERENCES property_types(id) ON UPDATE CASCADE,
...
CREATE TABLE room_types(
    ...
    created_at DATETIME DEFAULT NOW(),
    updated_at DATETIME ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (bed_type_id) REFERENCES bed_types(id) ON UPDATE CASCADE,
